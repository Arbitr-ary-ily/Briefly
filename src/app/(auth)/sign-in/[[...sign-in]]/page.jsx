            ...
            <>
              <SignIn.Step name="start">
                <Card className="w-full sm:w-96">
                  <CardHeader>
                    <CardTitle>Sign in to Briefly</CardTitle>
                  ...
                  <CardFooter>
                    <div className="grid w-full gap-y-4">
                      ...
                      <Button variant="link" size="sm" asChild>
                        <Link className="text-gray-800" href="/sign-up">Don&apos;t have an account? Sign up</Link>
                      </Button>
                    </div>
                  </CardFooter>
                </Card>
                ...
                <SignIn.Strategy name="password">
                  <Card className="w-full sm:w-96">
                    <CardHeader>
                      ...
                      Welcome back <span className="text-yellow-500 font-bold"><SignIn.SafeIdentifier /></span>
                      </p>
                    </CardHeader>
                    <CardContent className="grid gap-y-4">
                        ...
                        <div className="grid gap-y-2 items-center justify-center">
                          ...
                          <SignIn.Action
                            ...
                            fallback={({ resendableAfter }) => (
                              <Button className="text-gray-600" variant="link" size="sm" disabled>
